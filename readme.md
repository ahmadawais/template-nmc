...
[![DOWNLOADS](https://img.shields.io/npm/dt/template-nmc?label=DOWNLOADS%20%20❯&colorA=6A788D&colorB=6A788D&style=flat)](https://www.npmjs.com/package/template-nmc) [![Learn VSCode](https://img.shields.io/badge/-VSCODE.pro%20%E2%86%92-gray.svg?colorB=6A788D&style=flat)](https://VSCode.pro/?utm_source=GitHubFOSS)
[![Follow @MrAhmadAwais on Twitter](https://img.shields.io/badge/FOLLOW%20@MRAHMADAWAIS%20%E2%86%92-gray.svg?colorA=6A788D&colorB=6A788D&style=flat)](https://twitter.com/mrahmadawais/)

> A template for starting a new node-module CLI quickly.
...
```sh
template install ahmadawais/template-nmc nmc
```

Now this template is available as `nmc`.
...
Create a new node-module CLI with:

```sh
template create nmc cli-name-here
```
